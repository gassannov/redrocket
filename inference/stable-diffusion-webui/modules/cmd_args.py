...
parser.add_argument('--queue_name', type=str, help='rabbitmq queuename')
parser.add_argument('--port_rabbit', type=str, help='port for rabbitmq')
parser.add_argument('--ip', type=str, help='ip for rabbitmq')
parser.add_argument('--rabbit_user_name', type=str, help='user_name for rabbitmq')
parser.add_argument('--rabbit_password', type=str, help='password for rabbitmq')
