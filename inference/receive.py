...
def img2img_inference(image, prompt, seed, batch_size):
   # wrapped_img2img = wrap_gradio_gpu_call(img2img, extra_outputs=[None, '', ''])
    result = img2img('', 0, prompt, NEGATIVE_PROMPT, [], image, None, None, None, None, None, None, 20, 0,
                             4, 0, 1, False, False, 1, batch_size, 7, 1.5, 0.75, seed, -1.0, 0, 0, 0, False, 0,
                             512, 512, 0, 32, 0, '', '', '', '',  0, [], 0, None, 1, None, False, 'Scale to Fit(Inner Fit)',
...
def main():
    ...
    user_name = shared.cmd_opts.rabbit_user_name
    password = shared.cmd_opts.rabbit_password
